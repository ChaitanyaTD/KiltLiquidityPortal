          ...
          {activeTab === 'widget' ? (
            <>
              ...
              <div className="group relative">
                <div className="absolute inset-0 bg-gradient-to-br from-[#f26522]/10 to-transparent rounded-xl blur-sm"></div>
                <div className="relative bg-black/30 backdrop-blur-sm border border-[#f26522]/20 rounded-xl p-6 text-center">
                  <div className="text-[#f26522] mb-4">
